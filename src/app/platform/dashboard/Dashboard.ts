...
export class Dashboard {
  ...
  adjustLayout() {
    ...
    $(row[1]).removeClass('col-sm-0').addClass('col-sm-4 transition-width');
    // $(row[1]).removeClass('col-sm-0').addClass('col-sm-2 transition-width').after('<div class="col-sm-2 transition-width" id="dashboard"></div>');
  }
